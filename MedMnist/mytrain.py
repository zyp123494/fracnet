...
def main(flag, input_root, output_root, end_epoch, download,model):
    ''' main function
    ...
    else: model = ResNet50(in_channels = n_channels,num_classes = n_classes).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--download',
                        ...
                        type=str)          #in the origin code we cannot set download to false 
    
    parser.add_argument('--model',
                        default = 'resnet18',
                        help = 'model used in training and testing',
                        type = str)
